...
<body>
    ...
    <header>
        <div class="container">
        <h1><a href="index.php">WEB GALERI FOTO DITA</a></h1>
        <ul>
            ...
            <div class="box">
				...
				?>
                    <a href="galeri.php?kat=<?php echo $k['category_id'] ?>">
                        <div class="col-5">
                            <img src="img/lucu.jpeg" width="50px" style="margin-bottom:5px;" />
    ...
    <!-- footer -->
     <footer>
        <div class="container">
            <small>Copyright &copy; 2024 - Web Galeri Foto Dita.</small>
        </div>
    </footer>
</body>
</html>